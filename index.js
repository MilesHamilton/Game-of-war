...
class Deck {
  ...
  //  war () {
  //   for (let i = 0; i < 2; i++) {
  //     this.player1Deck[0].pop
  //     this.player2Deck[0].pop
  //      this.tableCards1.concat((this.player1Deck))
  //       this.tableCards2.concat(this.player2Deck)
  //   }
  //     return this.tableCards1, this.tableCards2
